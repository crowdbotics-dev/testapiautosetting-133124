...
class Testconnectors133124ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS133124_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS133124_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS133124"
